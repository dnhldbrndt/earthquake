...
public class EarthQuakeClient {
    ...
    public void closeToMe(){
        ...
        // TODO
        ArrayList<QuakeEntry> closest = filterByDistanceFrom(list,1000000.0, city);
        
        for (QuakeEntry quakeEntry : closest) {
    ...
    public void quakesOfDepth() {
        ...
        String source = "data/nov20quakedata.atom";
        ArrayList<QuakeEntry> list = parser.read(source);
        System.out.println("raed data for "+ list.size() +" quakes");
        double min = -4000.0;
        double max = -2000.0;
